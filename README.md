...
- `super-seo` - Create, audit, or optimize a single page for organic search
...
- `social-engagement` - Compliant Reddit/Quora outreach (find threads, draft answers, human-reviewed)
